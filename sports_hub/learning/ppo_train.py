...
def train(
    ...
    for it in range(num_evals_after_init):
        ...
        if process_id == 0:
            ...
            eval_episode_reward = metrics["eval/episode_reward"]
            if best_params_score is None:
                best_params_score = eval_episode_reward
                best_params = _unpmap(
                    (
                        training_state.normalizer_params,
                        training_state.params.policy,
            ...
            elif eval_episode_reward > best_params_score:
                best_params_score = eval_episode_reward
                best_params = _unpmap(
                    (
                        training_state.normalizer_params,
    ...
    # Return the parameters that gave the best evaluation score if this flag is true
    if return_best_params:
        print("Returning the best params")
        params = best_params
