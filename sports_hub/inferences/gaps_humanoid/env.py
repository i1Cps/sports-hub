...
# Inference environment for 'Gaps Humanoid'
class GapsHumanoid_Inference:
    def __init__(self, number_of_agents= 1, debug=False):
        scene_path = "sports_hub/inferences/gaps_humanoid/base_model.xml"
        ...
        self.observation_dim = 312
        self.action_dim = 17
        self.frame_skip = int(desired_frame_skip)

        # Environment constants
        self.path_to_brain_neurons = "agent_brains/gaps_humanoid/model"
    ...
    def _get_obs(self, data: mjx.Data, agent_id) -> jp.ndarray:
        ...
        ranges = _get_range_finders(data)                                                   # 30

        return jp.concatenate(
            [agent_qpos, agent_qvel, agent_cinert, agent_cvel, agent_qfrc_actuator, ranges]
        )
